    ...
    <div className="home-screen">
      ...
      <div className="header">
        ...
        <div className="right-header">
          <img src={networkIcon} alt="Excel" className="icon-header" />{" "}
          <img src={volumeIcon} alt="Excel" className="icon-header" />{" "}
          <img src={batteryIcon} alt="Excel" className="icon-header" />{" "}
        </div>
      </div>
      ...
      <div className="home-screen-icons">
        ...
        <div className="icon-container" onClick={openTerminal}>
      ...
      { terminalVisible && <TerminalScreen onClose={closeTerminal} /> }
